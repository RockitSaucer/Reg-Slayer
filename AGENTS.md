...
**Shipped (2026-08-20):** `APP_VERSION = '9.0-beta'` · badge **V9.0 Beta** · shell `reg-slayer-shell-v198`. Shared with Hunt except no track / share-location / pin photos. First login: one-time beta notice + Report an issue.
